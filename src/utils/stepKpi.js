...
export const PROGRESS_REVIEW_ALIGNMENT_1_CALLIBRATION_1 =
  "Performance Review Alignment 1 (Calibration 1)";
export const PROGRESS_REVIEW_ALIGNMENT_2_CALLIBRATION_2 =
  "Performance Review Alignment 2 (Calibration 2)";
...
export const stepKpiMonitoring = [PROGRESS_MONITORING_1, PROGRESS_MONITORING_2];
