            ...
            <Layout>
              <Row style={{paddingTop:50}}>
                <Col xl={6} lg={6} md={6} xs={24} className='grid'>
                  <br/><br/>
                  <img src={FileIcon} className='purple' style={{width:120, height: 120}}/>
                  <h1>Planning</h1>
                ...
                <Col xl={6} lg={6} md={6} xs={24} className='grid'>
                  <br/><br/>
                  <img src={UsersIcon} className='pink' style={{width:120, height: 120}}/>
                  <h1>Monitoring</h1>
                ...
                <Col xl={6} lg={6} md={6} xs={24} className='grid'>
                  <br/><br/>
                  <img src={CustomerIcon} className='yellow' style={{width:120, height: 120}}/>
                  <h1>Appraisal</h1>
                ...
                <Col xl={6} lg={6} md={6} xs={24} className='grid'>
                  <br/><br/>
                  <img src={collaborationIcon}  className='green' style={{width:120, height: 120}}/>
                  <h1>My Team</h1>
