...
class Chat extends Component {
  ...
  getAllData = async () => {
    const { GetThreadActivity, GetActivityThreadChat, match } = this.props;
    const { params } = match;
...
const mapDispatchToProps = (dispatch) => ({
  ...
  GetActivityThreadChat: (idActivity, idChat) =>
    dispatch(getActivityThreadChat(idActivity, idChat)),
  doFeedback: (data) => dispatch(createChat(data)),
});

const connectToComponent = connect(mapStateToProps, mapDispatchToProps)(Chat);
